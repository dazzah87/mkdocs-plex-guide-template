...
Wenn Du Dich mit meinem Plex-Server verbindest, erhältst Du Zugriff auf meine Medienbibliothek, ohne selbst einen Server einrichten oder warten zu müssen.
